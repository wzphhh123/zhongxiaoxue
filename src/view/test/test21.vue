      ...
      let option = {
        ...
        geo3D: {
          ...
          itemStyle: {
            ...
            areaColor: {
                type: "pattern",
                image: require('@/assets/images/mapBg.png'), //配置图片
        ...
        series: [
          {
            ...
            itemStyle: {
              ...
              borderColor: "#fff",
              color: {
                image: require('@/assets/images/mapBg.png'),
                repeat: 'repeat'
              },
              areaColor: {
                type: "pattern",
